...
`D:\AI\EducationLearning\mock-exam-timer-flow`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/mock-exam-timer-flow-docs.zip` を取得できることを確認する。
