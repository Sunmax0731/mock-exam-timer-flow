...
2. `dist/mock-exam-timer-flow-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/mock-exam-timer-flow.git
cd mock-exam-timer-flow
